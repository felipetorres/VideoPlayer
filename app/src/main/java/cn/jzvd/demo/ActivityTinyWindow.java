...
public class ActivityTinyWindow extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mJzVideoPlayerStandardGlide.setUp("http://jzvd.nathen.cn/342a5f7ef6124a4a8faf00e738b8bee4/cf6d9db0bd4d41f59d09ea0a81e918fd-5287d2089db37e62345123a1be272f8b.mp4",
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tiny_window:
                mJzVideoPlayerStandardGlide.startWindowTiny();
                break;
